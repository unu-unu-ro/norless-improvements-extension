...
## AI Assistant Rules Sync

This file is kept byte-identical with the Claude Code rules file:
...
**When you update these rules, run the sync script after saving — the file you edited is the source of truth:**
